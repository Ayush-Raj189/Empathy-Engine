...
.sidebar-logo-icon { font-size: 2.5rem; display: block; margin-bottom: 0.4rem; }
.sidebar-logo-name { font-size: 1.1rem; font-weight: 600; color: var(--text-primary); }
.sidebar-logo-version { font-size: 0.7rem; font-family: var(--font-mono); color: var(--text-muted); }
...
.step-content { flex: 1; }
.step-title { font-size: 0.88rem; font-weight: 600; color: var(--text-primary); margin-bottom: 2px; }
        ...
        if st.session_state.get("history"):
            ...
            for i, h in enumerate(reversed(st.session_state.history[-5:])):
                ...
                <div class="history-item">
                  ...
                  <span style="font-size:0.8rem;color:#94a3b8;margin-left:6px;
                               font-family:var(--font-mono)">
...
def render_main():
    ...
    if run_btn:
        ...
        with st.spinner("Analysing emotion and synthesising voice…"):
            ...
            try:
                ...
                st.session_state["audio_key"] = int(time.time() * 1000)
      ...
      <div style="display:flex;align-items:center;gap:16px;flex-wrap:wrap">
        ...
        <div style="margin-left:auto">
          <div style="display:flex;gap:10px;align-items:center">
            ...
            <div style="width:5px;height:60px;border-radius:3px;
    ...
    with col_a:
        ...
        if Path(ar.file_path).exists():
            # Read fresh bytes every time — no browser caching
            ...
            <div class="glass-card" style="border-color:rgba({_hex_to_rgb(color)},0.2);
                         background:rgba({_hex_to_rgb(color)},0.04);margin-top:1rem">
        ...
        with v_col:
            ...
            <div class="metric-box">
              <div class="metric-value"
                   style="color:{'#10b981' if er.valence>0 else '#ef4444'};font-size:1.4rem">
    ...
    with tab1:
        ...
        <div class="info-box" style="margin-bottom:1rem">
          SSML is generated alongside each audio file and can be used with
          Google Cloud TTS, Amazon Polly, or ElevenLabs for richer synthesis.
        </div>
        """, unsafe_allow_html=True)
...
def _render_onboarding():
    ...
    examples = [
        ("🎉", "Excitement", "#EF4444", "Energetic, ALL-CAPS, multi-exclamation text"),
        ("😢", "Sadness",    "#6366F1", "Slower, lower, softer for empathetic contexts"),
        ("😠", "Anger",      "#DC2626", "Fast, forceful for escalated complaints"),
        ("🤔", "Curiosity",  "#14B8A6", "Measured, inquisitive tone"),
    ]
